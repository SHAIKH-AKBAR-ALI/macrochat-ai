...
export const ko: { [S in keyof PageStrings]?: Partial<PageStrings[S]> } = {
  ...
  legal: {
    "about.title": "소개 — MacroChat AI",
    "about.eyebrow": "소개",
    "about.h1a": "정직한 숫자,",
    "about.h1b": "추측은 제로.",
    "about.s1h": "MacroChat을 만든 이유",
    "about.s1p":
      "대부분의 칼로리 앱은 드롭다운을 뒤지고 모든 걸 저울에 올리게 만듭니다. 대부분의 AI 트래커는 모델이 숫자를 지어내도록 내버려 둡니다. MacroChat은 둘 다 하지 않습니다. 사람에게 말하듯 «구운 닭가슴살 200g, 로티 2장»이라고 적거나 사진을 보내면 됩니다. 표시되는 모든 칼로리는 실제 영양 데이터베이스에서 오며, AI의 상상에서 나온 값은 하나도 없습니다.",
    "about.s2h": "정직함을 지키는 방법",
    "about.s2p":
      "AI가 하는 일은 음식을 식별하고 분량을 추론하는 것뿐입니다. 영양소는 USDA FoodData Central과 인도 영양 데이터뱅크(INDB)에서 가져옵니다. 하루 합계는 언어 모델이 아니라 백엔드가 계산합니다. 사진으로 분량을 추정한 경우에는 그 사실을 알리고, 기록에 반영하기 전에 확인을 요청합니다.",
    "about.s3h": "인도 음식도 지원",
    "about.s3p":
      "USDA가 전 세계의 일상적인 식품을 담당하고, INDB의 1,000가지가 넘는 인도 요리와 식재료가 로티, 달, 사브지, 비리야니를 담당합니다. 식단의 양쪽 모두를 하나의 트래커로 기록하세요.",

    "privacy.title": "개인정보 처리방침 — MacroChat AI",
    "privacy.eyebrow": "개인정보 처리방침",
    "privacy.h1": "당신의 데이터, 있는 그대로.",
    "privacy.updated": "최종 업데이트: 2026년 7월",
    "privacy.s1h": "수집하는 정보",
    "privacy.s1p":
      "하루 목표치를 계산하기 위한 계정 정보(이메일, 키, 체중, 나이, 성별, 활동 수준, 목표, 시간대), 기록한 식사와 메시지, 그리고 음식 식별을 위해 처리되는 업로드 사진입니다.",
    "privacy.s2h": "이용 방식",
    "privacy.s2p":
      "식사 텍스트와 사진은 음식과 분량을 식별하는 목적으로만 AI 제공업체(OpenAI, 게스트 세션은 Google Gemini)로 전송됩니다. 영양 수치는 공개 데이터베이스(USDA, INDB)에서 가져옵니다. 데이터는 서비스 운영에만 사용하며, 판매하거나 광고에 사용하지 않습니다.",
    "privacy.s3h": "저장 위치",
    "privacy.s3p":
      "계정과 식사 기록은 행 수준 보안이 적용된 Supabase(Postgres)에 저장되며, 인증된 본인 계정만 자신의 행을 읽을 수 있습니다. 게스트 분석은 전혀 저장되지 않습니다.",
    "privacy.s4h": "선택할 수 있는 것",
    "privacy.s4pPre": "아무것도 저장하지 않고 게스트로 MacroChat을 사용할 수 있습니다. 계정과 관련 데이터를 모두 삭제하려면 ",
    "privacy.s4pLink": "문의해 주세요",
    "privacy.s4pPost": ". 삭제는 되돌릴 수 없습니다.",

    "terms.title": "이용약관 — MacroChat AI",
    "terms.eyebrow": "이용약관",
    "terms.h1": "약관, 짧게.",
    "terms.updated": "최종 업데이트: 2026년 7월",
    "terms.s1h": "1. 의학적 조언이 아닙니다",
    "terms.s1p":
      "MacroChat은 영양 기록 도구이며 의료 서비스가 아닙니다. 칼로리와 영양소 수치는 추정값이고, 특히 분량이 그렇습니다. 건강과 관련한 결정을 내리기 전에, 특히 질환이 있다면 자격을 갖춘 전문가와 상담하세요.",
    "terms.s2h": "2. 정확성",
    "terms.s2p":
      "실제 데이터베이스(USDA, INDB)에서 수치를 가져오고 추정 분량은 분명히 표시하지만, 어떤 값의 정확성도 보장하지 않습니다. 직접 확인해 입력한 그램 수는 이용자 책임입니다.",
    "terms.s3h": "3. 계정",
    "terms.s3p":
      "로그인 정보를 안전하게 관리하세요. 계정에서 이루어진 활동은 본인 책임입니다. 서비스를 남용하지 마세요(자동 스크래핑, 다른 이용자 데이터 접근 시도, API 과부하).",
    "terms.s4h": "4. 서비스 제공",
    "terms.s4p":
      "이 서비스는 개인 프로젝트로 있는 그대로 제공되며 가동률을 보장하지 않습니다. 기능은 언제든 변경되거나 중단될 수 있습니다.",
    "terms.s5h": "5. 문의",
    "terms.s5pPre": "약관에 대해 궁금한 점이 있으신가요? ",
    "terms.s5pLink": "연락 주세요",
    "terms.s5pPost": ".",

    "contact.title": "문의 — MacroChat AI",
    "contact.eyebrow": "문의",
    "contact.h1": "인사 남겨 주세요.",
    "contact.s1h": "이메일",
    "contact.s1p": "버그 신고, 기능 제안, 데이터 삭제 요청 등 무엇이든:",
    "contact.s2h": "숫자가 이상한가요?",
    "contact.s2p":
      "음식이 데이터베이스의 잘못된 항목에 매칭되었거나 칼로리가 이상해 보이면 스크린샷을 보내 주세요. 매칭 정확도야말로 저희가 가장 고치고 싶은 부분입니다.",

    "govern": "이 페이지는 편의를 위한 번역입니다. 영어판이 우선합니다.",
  },
};
